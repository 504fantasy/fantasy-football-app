...
def init_db(conn=None):
    ...
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN rush_td_40           INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN rush_td_50           INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN rec_td_40            INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN rec_td_50            INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN pat_made             INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN fg_missed            INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN sacks                REAL DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN safeties             INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN forced_fumbles       INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN blocked_kicks        INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE survivor_player_scores  ADD COLUMN points_allowed       INTEGER")
