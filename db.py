...
def init_db(conn=None):
    ...
    _safe_alter(conn, "ALTER TABLE leagues       ADD COLUMN scoring_settings   TEXT")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN passing_tds       INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN other_tds         INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN two_pt_conversions   INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN pass_40_completions  INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN pass_td_40           INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN pass_td_50           INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN rush_td_40           INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN rush_td_50           INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN rec_td_40            INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN rec_td_50            INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN pat_made             INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN fg_missed            INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN sacks                REAL DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN safeties             INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN forced_fumbles       INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN blocked_kicks        INTEGER DEFAULT 0")
    _safe_alter(conn, "ALTER TABLE player_scores ADD COLUMN points_allowed       INTEGER")
